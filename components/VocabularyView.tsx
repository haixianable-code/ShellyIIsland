...
const VocabularyView: React.FC<VocabularyViewProps> = ({ words, progress, onWordClick, onAddExtraWords }) => {
  ...
  return (
    <div className="space-y-10 animate-fadeIn">
      ...
      <div className="relative group">
        <div className="absolute left-6 top-1/2 -translate-y-1/2 bg-[#8bc34a] p-2 rounded-xl shadow-sm border-2 border-white z-10">
        ...
        <input 
          ...
          className="pl-20 pr-8 py-5 bg-white border-4 border-[#e0d9b4] rounded-[3rem] w-full shadow-[0_6px_0_#e0d9b4] focus:outline-none focus:ring-8 focus:ring-[#8bc34a]/30 transition-all font-black text-[#4b7d78] placeholder:text-[#8d99ae]/50"
        />
      </div>
        ...
        {filteredWords.map(word => {
          ...
          return (
            <button 
              ...
              className="bg-white p-8 rounded-[4rem] border-4 border-[#f0f0f0] shadow-[0_12px_0_rgba(0,0,0,0.06)] hover:shadow-[0_16px_0_rgba(139,195,74,0.15)] hover:border-[#8bc34a] transition-all flex items-center justify-between group cursor-pointer active:translate-y-2 active:shadow-none text-left"
            >
